if os.date('%Y%m%d') > '20200725' then
...
if SSQ[3] == true then MicroAimbot() end
if SSQ[4] == true then UltraAimbot() end
if SSQ[5] == true then AntiShake() end
if SSQ[6] == true then SmailCrosshair() end
if SSQ[7] == true then SpeedKnock() end 
if SSQ[8] == true then MoreDamage() end 
if SSQ[9] == true then HeadshotMenu() end
if SSQ[10] == true then MagicBulletMenu() end
if SSQ[11] == true then ZoomMenu() end
if SSQ[12] == true then ScopeMenu() end
if SSQ[13] == true then HOME() end
end
end
...
if SS[6] == true then SpeedParachuteV1() end  
if SS[7] == true then SpeedParachuteV2() end  
