...
if SSQ[3] == true then SmallCroshair() end
if SSQ[4] == true then AntiShake() end
if SSQ[5] == true then Wallshot() end
if SSQ[6] == true then UltraAimbot() end
if SSQ[7] == true then MicroAimbot() end
if SSQ[8] == true then SpeedKnock() end 
if SSQ[9] == true then MoreDamage() end 
if SSQ[10] == true then HeadshotMenu() end
if SSQ[11] == true then MagicBulletMenu() end
if SSQ[12] == true then ZoomMenu() end
if SSQ[13] == true then ScopeMenu() end
if SSQ[14] == true then HOME() end
end
end
