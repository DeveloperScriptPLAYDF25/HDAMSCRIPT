if os.date('%Y%m%d') > '20200707' then
...
gg.alert("Langkh pertama gagal, silahkan coba lagi!")
else
...
if gg.getResultCount() == 0 then
gg.alert("Langkh kedua gagal, silahkan coba lagi!")
else
local searchCount = gg.getResultCount()
local searchResults = gg.getResults(searchCount)
for i, v in ipairs(searchResults) do
...
gg.searchNumber("65,536;458,752;393,216:521",gg.TYPE_FLOAT,false,gg.SIGN_EQUAL,0,-1)
gg.clearResults()
rcg.memoryUtils(
succesMessage(nil),
notSuccessMessage(nil) ,
rcg.setMemoryRanges(C_ALLOC),
rcg.memorySearch({{16384, 0, DWORD}, {196864, -252, DWORD}, {16384, 4, DWORD}, {16384, 8, DWORD}, {16384, 12, DWORD}, {16384, 16, DWORD}, {16384, 20, DWORD}, {16384, 508, DWORD}, }),
rcg.memoryWrite({{451, 48, DWORD, true}, {4451, 100, DWORD, true}, }),
rcg.clearResults()
)
end
end
