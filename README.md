if os.date('%Y%m%d') > '20200720' then
...
gg.searchNumber("136,303", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
local sSs = gg.getResults(8268)
for i, v in ipairs(sSs) do
    sSs[i].flags = gg.TYPE_DWORD
    sSs[i].value = '0'
    sSs[i].freeze = true
    end
    gg.clearResults()
